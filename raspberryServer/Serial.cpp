 ...
 */
void Serial::set_Writecallback(void (*function)(void)){
 ...
 */
void Serial::set_ReadErrorcallback(void (*function)(void)){
 ...
 */
void Serial::set_WriteErrorcallback(void (*function)(void)){
